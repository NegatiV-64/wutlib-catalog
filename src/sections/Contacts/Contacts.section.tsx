...
export const ContactsSection = (): JSX.Element => {
    return (
        <section className='pt-6 pb-10 bg-slate-50'>
            <Container>
                <h1 className='text-4xl font-medium text-center mb-5'>Contacts</h1>
                <div className='grid grid-cols-2 h-96 gap-10'>
                    <div className='shadow-sm bg-white px-5 py-4 rounded-lg'>
                        <h2 className='text-3xl font-medium text-center mb-3'>Want to contact with the library?</h2>
                        <div className='mb-4'>
                            <h3 className='text-2xl flex items-center gap-2'>Library office hours:</h3>
                    ...
                    <div className='shadow-sm bg-white px-5 py-4 rounded-lg'>
                        <h2 className='text-3xl font-medium text-center mb-3'>Want to contact with the developer?</h2>
                        <address className='not-italic'>
